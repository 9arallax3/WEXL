<script>
    ...
    import {randomClock_hr, rot_degree} from './jsfiles/clock.js';

    let clockObj = randomClock_hr();
    let hours;
        ...
        <div class = "row">
            <div class = "col-6">
                ...
                <svg class="clock" viewBox="-15 -12 100 125">
                    <!-- drawing the outer circles for frame-->
                ...
                <!-- Drawing the inner markings that show on clock's face-->
                <g class="lines">
            ...
            <div class = "col-6">
                <h3>The time is now _?_ O'clock!</h3>
