<script>
    import NPad from './Keypad2.svelte';
    ...
    let correct_answer = cnt_rn2;
    let total = cnt_rn1 + cnt_rn2;
    let usr_resp = -1;
    ...
    function init_count10() {
        ...
        correct_answer = cnt_rn2;
        total = cnt_rn1 + cnt_rn2;
        usr_resp = -1;
        ans_submit = false;
    };
    init_count10();
...
<div class="stack-large">
    <div>
        ...
        <img src={num.ARTH_REPO[num.ADD_SYMB].num_digit} align="middle" width=10%  height=auto />
        <img src={num.ARTH_REPO[num.BOX_SYMB].num_digit} align="middle" width=5%  height=auto />
        <img src={num.ARTH_REPO[num.EQL_SYMB].num_digit} align="middle" width=10%  height=auto />
        <img src={num.NUMDIGIT_REPO[total].num_digit} align="middle" width=10%  height=auto />
    </div>
