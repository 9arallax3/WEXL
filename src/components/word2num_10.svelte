...
<div class="stack-large">
    <div>
        <p style="color:gray">Practice reading number words upto 10: </p>
        <h3>Enter the number in digits: </h3>
        <h2> {num_txt} = ? </h2>
    </div>
    ...
    <button type="button" class="btn toggle-btn" on:click={ () => init_word2num_10()}> Rerun</button>
