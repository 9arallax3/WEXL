...
export function taskOne() {
  ...
  task01.question = "Rick has "+task01.valueArray[0]+" toys in his toy box. One day, he knocks the toy box over and "+task01.valueArray[1]+" toys spill onto the floor. How many toys are still in the box?";
