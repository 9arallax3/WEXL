...
export function taskOne() {
  ...
  task01.question = "Which is not a way to make "+task01.questionValue+" ?";
  task01.valueArray = [];
  task01.columns = 2;
  ...
  task01.valueArray = randomArrayNumbers(showbtn,ans.length,0,ans);
  task01.answer = opts[Math.floor(Math.random() * opts.length)];
