<script>
    ...
    function init_shapes() {
        ...
        correct_answer = COUNT_HIGHNUM - cnt_rn;
...
<div class="stack-large">
    <div>
        ...
        <p style="color:gray">A full frame has 10 squares with shapes.</p>
        <h2>How many more {images.BOX_SHPCOLOR_REPO[img_rn].color} {images.BOX_SHPCOLOR_REPO[img_rn].shape}s do you need to make 10? </h2>
