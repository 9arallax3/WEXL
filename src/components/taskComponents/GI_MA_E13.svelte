<script>
    ...
    import {taskOne} from '../taskjs/GI_MA_E13';
    ...
    <div class="shadow-sm  bg-white rounded">
     ...
     <div class = " bg-light rounded-bottom p-3 pb-5 pt-5">         
       <div >
           ...
           <h6>Write an addition number sentence that fits the story.</h6>
           <input class='input-user'  type="text" style="margin-left: 5px;" bind:value="{answer}" maxlength=10> 
       </div>  

       <div>
           <h5 style=" display: {showNext};" class="mt-5">{showPopUp}</h5>          
        </div>
        <Solution num_qnty={task01.columns} usr_resp={answer} num={task01.valueArray} ans_submit={showSolution} answerchange={task01.answer}/>
       <div class="mt-3">
