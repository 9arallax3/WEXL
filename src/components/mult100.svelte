...
<div class="stack-large">
    <div>
        <p style="color:gray">Practice multiplying numbers upto 100: </p>
        <h3>Multiple the two numbers: </h3>
    ...
    <button type="button" class="btn toggle-btn" on:click={ () => init_mult100()}> Rerun</button>
