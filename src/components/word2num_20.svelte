...
<div class="stack-large">
    <div>
        <p style="color:gray">Practice reading number words upto 20: </p>
    ...
    <button type="button" class="btn toggle-btn" on:click={ () => init_word2num_20()}> Rerun</button>
